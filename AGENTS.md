...
- Tutorials: `src/lib/tutorials/<category>/<tutorial-id>/` with `config.json`, `en-README.md`, `zh-README.md`, and shader files (`fragment.glsl`, `fragment-exercise.glsl`).
...
- GLSL tutorial files use lowercase with dashes and stay colocated under each tutorial directory.
...
- Tutorial shaders are loaded from the filesystem/API as source strings and compiled in the browser with WebGL.
