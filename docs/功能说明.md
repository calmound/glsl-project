...
- Shaders 支持：教程与预览当前通过文件系统/API 读取 GLSL 源码字符串，并在前端用 WebGL 直接编译执行。
...
- 静态内容页：
  - 英文根路径：`/about`、`/examples`。
  - 本地化版本：`/[locale]/about`、`/[locale]/examples`。
- 站点地图与 Robots：
...
- 公共页：
  - `/`（英文首页）
  - `/learn`（英文教程列表）
  - `/about`、`/examples`（英文静态页）
  - `/[locale]`、`/[locale]/learn`、`/[locale]/about`、`/[locale]/examples`
- 教程详情：
