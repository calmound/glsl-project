...
export function TermsPageContent({ locale }: TermsPageContentProps) {
        ...
        <div className="prose prose-lg max-w-none text-gray-700">
          {locale === 'zh' ? (
            ...
            <>
              ...
              <h2>11. Contact Us</h2>
              <p>
                If you have any questions regarding these Terms, please contact us at: <a href={`mailto:${email}`}>{email}</a>.
              </p>
            </>
          )}
        </div>
