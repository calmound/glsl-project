...
const translations = {
  ...
  en: {
    ...
    'home.learning.description': 'We have carefully designed a complete learning path for you, from beginner to professional level, with detailed guidance and practical exercises at every step. Whatever your goal, we can help you achieve it.',
    ...
    'home.cta.description': 'Join our learning platform and start mastering modern graphics programming skills today. Whether you want to enhance your professional skills or pursue it out of pure interest, we will accompany you every step of the way.',
...
export const LanguageProvider: React.FC<LanguageProviderProps> = ({ children }) => {
  ...
  // 从localStorage读取语言偏好
  useEffect(() => {
    const savedLanguage = localStorage.getItem('glsl-language') as Language;
  ...
  const setLanguage = (lang: Language) => {
    ...
    localStorage.setItem('glsl-language', lang);
  };
